...
// Register Custom Taxonomy
function siecle_taxonomy() {

	$labels = array(
		'name'                       => _x( 'Siècles', 'Taxonomy General Name', 'starter' ),
		'singular_name'              => _x( 'Siècle', 'Taxonomy Singular Name', 'starter' ),
		'menu_name'                  => __( 'Siècle', 'starter' ),
		'all_items'                  => __( 'All Siècles', 'starter' ),
		'parent_item'                => __( 'Parent Siècle', 'starter' ),
		'parent_item_colon'          => __( 'Parent Siècle:', 'starter' ),
		'new_item_name'              => __( 'New Siècle', 'starter' ),
		'add_new_item'               => __( 'Add New Siècle', 'starter' ),
		'edit_item'                  => __( 'Edit Siècle', 'starter' ),
		'update_item'                => __( 'Update Siècle', 'starter' ),
		'view_item'                  => __( 'View Siècle', 'starter' ),
		'separate_items_with_commas' => __( 'Separate Siècles with commas', 'starter' ),
		'add_or_remove_items'        => __( 'Add or remove Siècles', 'starter' ),
		'choose_from_most_used'      => __( 'Choose from the most used', 'starter' ),
		'popular_items'              => __( 'Popular Siècles', 'starter' ),
		'search_items'               => __( 'Search Siècles', 'starter' ),
		'not_found'                  => __( 'Not Found', 'starter' ),
		'no_terms'                   => __( 'No Siècles', 'starter' ),
		'items_list'                 => __( 'Siècles list', 'starter' ),
		'items_list_navigation'      => __( 'Siècles list navigation', 'starter' ),
	);
	$args = array(
		'labels'                     => $labels,
		'hierarchical'               => false,
	...
	register_taxonomy( 'siecle', array( 'ecrivain' ), $args );

}
add_action( 'init', 'siecle_taxonomy', 0 );